...
@section('content')
    <div class="d-flex justify-content-center mb-3">
        <form action="{{ route('suggestions.search') }}" style="width: 300px">
            @csrf
            <input type="search" name="search" class="form-control form-control-sm bg-white" placeholder="Search for names" autofocus>
        </form>
    </div>
